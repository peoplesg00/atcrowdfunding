...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            <img class="img-circle" src="${APP_PATH}/img/p1.jpg" alt="Generic placeholder image"
        ...
        <div class="col-lg-4">
            <img class="img-circle" src="${APP_PATH}/img/p2.jpg" alt="Generic placeholder image"
                 style="width: 140px; height: 140px;">
            <h2>NEOKA智能手环</h2>
        ...
        <div class="col-lg-4">
            <img class="img-circle" src="${APP_PATH}/img/p3.png" alt="Generic placeholder image"
                 style="width: 140px; height: 140px;">
            <h2>驱蚊扣</h2>
    ...
    <div class="container">
        <div class="row clearfix">
            <div class="col-md-12 column">
                <div id="footer">
                    <div class="footerNav">
                        <a rel="nofollow" href="http://www.atli.com">关于我们</a> | <a rel="nofollow"
                                                                                   href="http://www.atli.com">服务条款</a> |
                        <a rel="nofollow" href="http://www.atli.com">免责声明</a> | <a rel="nofollow"
                                                                                   href="http://www.atli.com">网站地图</a> |
